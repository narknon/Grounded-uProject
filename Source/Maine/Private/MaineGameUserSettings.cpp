...
UMaineGameUserSettings::UMaineGameUserSettings() {
    ...
    this->VoiceChatActivation = EVoiceChatActivation::;
    ...
    this->InteractHighlightLevel = EInteractHighlightLevel::;
    this->bExtraWideInteract = false;
    this->LanguageSetting = ELanguageSetting::;
    this->MotionBlurScale = 0.00f;
    this->ChromaticAberration = true;
    this->GammaLevel = 0.00f;
    this->FPSLimit = EFPSLimit::;
    ...
    this->DefaultQualitySettings = EScalabilitySettings::;
    this->QualitySettings = EScalabilitySettings::;
    ...
    this->ColorBlindSetting = EColorBlindModeSettings::;
    this->SubtitlesSetting = ESubtitleVerbositySettings::;
    this->SubtitleSizeSetting = ESubtitleSizeSettings::;
