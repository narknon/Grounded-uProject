...
void UMaineGameUserSettings::SetReticleSize(float Setting) {
}

void UMaineGameUserSettings::SetReticleOpacity(float Setting) {
}
...
void UMaineGameUserSettings::SetHasSeenXboxLoginMessage(bool bState) {
}
...
void UMaineGameUserSettings::SetCreatureSpawnerGroundSnap(bool Setting) {
}

void UMaineGameUserSettings::SetCreatureSpawnerAIOn(bool Setting) {
}
...
void UMaineGameUserSettings::SetCinematicsSoundVolume(float Value) {
}
...
float UMaineGameUserSettings::GetReticleSize() const {
    return 0.0f;
}

float UMaineGameUserSettings::GetReticleOpacity() const {
    return 0.0f;
}
...
bool UMaineGameUserSettings::GetHasSeenXboxLoginMessage() const {
    return false;
}
...
bool UMaineGameUserSettings::GetCreatureSpawnerGroundSnap() const {
    return false;
}

bool UMaineGameUserSettings::GetCreatureSpawnerAIOn() const {
    return false;
}
...
float UMaineGameUserSettings::GetCinematicsSoundVolume() const {
    return 0.0f;
}
...
UMaineGameUserSettings::UMaineGameUserSettings() {
    ...
    this->bHasSeenEarlyAccessMessage = false;
    this->bHasSeenXboxLoginMessage = true;
    this->MasterSoundVolume = 0.00f;
    this->EffectsSoundVolume = 0.00f;
    this->AmbienceSoundVolume = 0.00f;
    this->MusicSoundVolume = 0.00f;
    this->UISoundVolume = 0.00f;
    this->NarrationSoundVolume = 0.00f;
    this->CinematicsSoundVolume = 0.00f;
    this->VoiceSoundVolume = 0.00f;
    this->VoiceChatSoundVolume = 0.00f;
    this->VoiceChatActivation = (EVoiceChatActivation)140698270272880;
    ...
    this->MouseSensitivityValueX = 0.00f;
    this->MouseSensitivityValueY = 0.00f;
    ...
    this->bControllerRumbleEnabled = false;
    this->ControllerLeftInnerDeadZone = 0.00f;
    this->ControllerLeftOuterDeadZone = 0.00f;
    this->ControllerRightInnerDeadZone = 0.00f;
    this->ControllerRightOuterDeadZone = 0.00f;
    this->AutosaveInterval = 0.00f;
    this->AutosavesNumber = 0.00f;
    this->bShowTutorial = true;
    this->InteractHighlightLevel = (EInteractHighlightLevel)140698270272880;
    this->bExtraWideInteract = false;
    this->LanguageSetting = (ELanguageSetting)140698270272880;
    this->MotionBlurScale = 0.00f;
    this->ChromaticAberration = true;
    this->GammaLevel = 0.00f;
    this->FPSLimit = (EFPSLimit)140698270272880;
    this->Resolution3D = 0.00f;
    this->bHasRunHardwareBenchmark = true;
    this->bHasAppliedInitialAccessibility = false;
    this->bHasWarnedForUnsafeValues = false;
    this->DefaultQualitySettings = (EScalabilitySettings)140698270272880;
    this->QualitySettings = (EScalabilitySettings)140698270272880;
    this->FSRQualityLevel = 0.00f;
    this->CustomFieldOfView = 0.00f;
    this->bSpecialPerformance = false;
    this->HDRMaxBrightness = 0.00f;
    this->HDRContrast = 0.00f;
    this->HDRUIBrightness = 0.00f;
    this->HDRUIContrast = 0.00f;
    this->ColorBlindSetting = (EColorBlindModeSettings)140698270272880;
    this->SubtitlesSetting = (ESubtitleVerbositySettings)140698270272880;
    this->SubtitleSizeSetting = (ESubtitleSizeSettings)140698270272880;
    this->bChatBackground = false;
    this->bSubtitleBackground = false;
    this->ArachnophobiaSafeMode = 0.00f;
    this->bReadToMe = false;
    this->ReadToMeSpeed = 0.00f;
    this->bChatTextToSpeech = false;
    this->bChatSpeechToText = false;
    this->bLargeText = false;
    this->bPartyDistance = false;
    this->ReticleSize = 0.00f;
    this->ReticleOpacity = 0.00f;
    this->bCreatureSpawnerAIOn = false;
    this->bCreatureSpawnerGroundSnap = false;
}
