...
public:
	...
	bool CompressPayload(const FString &Payload, TArray<uint8> &Compressed)
	{
		...
		bool CompressSuccessful = FCompression::CompressMemory(TEXT("COMPRESS_GZIP" "COMPRESS_BiasMemory"), Compressed.GetData(), CompressedSize, UncompressedPtr, UncompressedSize);
	...
	{
		FHttpRequestRef request = FTelemetryService::CreateServiceRequest();
